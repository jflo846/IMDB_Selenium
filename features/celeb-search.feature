Feature: I want to seach IMDB for all kind of celebs
  ...
  Scenario: No results shown
    ...
    And 08-08 as day and month for birth date
    And press the button to search for people who are not yet born
    Then I shall see that there are no celebrities born on the day I searched for
    And if I click on the IMDB home button I shall come back to the startpage